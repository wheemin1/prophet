...
export function PersonalizationForm({ profile, onProfileChange }: PersonalizationFormProps) {
  ...
  return (
    <Card className="mystical-gradient border-mystical-gold/20 backdrop-blur-sm">
      <CardHeader className="text-center">
        <CardTitle className="text-xl text-mystical-gold">개인화 입력</CardTitle>
        <p className="text-sm text-mystical-silver">
          입력 정보는 서버에 저장하지 않고 예언 생성 시드로만 사용합니다
        </p>
      </CardHeader>
      <CardContent>
